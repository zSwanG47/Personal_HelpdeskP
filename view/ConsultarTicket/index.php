...
<html>
	...
	<title>Amazon Experience - Consultar Ticket</title>
</head>
				...
				<div class="row" id="viewuser">
					...
					<div class="col-lg-2">
						<fieldset class="form-group">
							...
							<button type="submit" class="btn btn-rounded btn-success btn-block" id="btnfiltrar">Filtrar</button>
						</fieldset>
					</div>
					...
					<div class="col-lg-2">
						<fieldset class="form-group">
							...
							<button class="btn btn-rounded btn-success btn-block" id="btntodo">Ver Todo</button>
						</fieldset>
					</div>
				</div>
